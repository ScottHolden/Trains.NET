    ...
    internal class TrainRenderer : ITrainRenderer
    {
        ...
        public void Render(ICanvas canvas, Train train)
        {
            ...
            var outline = new PaintBrush
            {
                ...
                StrokeWidth = _trainParameters.OutlineWidth
            };
            ...
            canvas.DrawCircle(startPos + _trainParameters.RearWidth + _trainParameters.HeadWidth - 5, 0, _trainParameters.OutlineWidth, smokeStack);
